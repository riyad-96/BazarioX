  ...
  return (
    <div>
      <h4 className="mb-4 flex items-center gap-2 pl-1">
        ...
        <span className="text-sm font-light opacity-70">since {createdAt}</span>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="grid aspect-4/2 content-center justify-items-center rounded-lg bg-(--primary) shadow">
          <span className="text-lg opacity-70 md:text-2xl">{Math.round(stat.current.totalSpent).toLocaleString()} ৳</span>
          <span className="text-sm sm:text-base">Spent</span>
        </div>
        <div className="grid aspect-4/2 content-center justify-items-center rounded-lg bg-(--primary) shadow">
          <span className="text-lg opacity-70 md:text-2xl">{stat.current.totalItems}</span>
          <span className="text-sm sm:text-base">Items</span>
        </div>
        <div className="grid aspect-4/2 content-center justify-items-center rounded-lg bg-(--primary) shadow">
          <span className="text-lg opacity-70 md:text-2xl">{stat.current.totalSessions}</span>
          <span className="text-sm sm:text-base">Sessions</span>
        </div>
        <div className="grid aspect-4/2 content-center justify-items-center rounded-lg bg-(--primary) shadow">
          <span className="text-lg opacity-70 md:text-2xl">{stat.current.lastSession}</span>
